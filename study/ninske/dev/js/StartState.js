var StartState = function() {
  ...
  return {
    ...
    preload: function(){
      game.load.image('ninsuke_hitarea', '../../../common/img/ninsuke_hitarea.png');
      game.load.spritesheet('ninsuke', '../../../common/img/ninsuke2.png', 32, 32);
      game.load.image('wall', '../../../common/img/block_min_3.png');
    },
    create: create,
    update: function(){
